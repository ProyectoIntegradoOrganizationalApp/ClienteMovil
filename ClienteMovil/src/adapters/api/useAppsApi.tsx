 ...
 */
export const useAppsApi = (fetch: boolean) => {
  const { user } = useAuth();
  ...
  const createApp = (name: string, description: string, id: string) => {};

  const editApp = (id: string, newName: string, newDescription: string) => {};
