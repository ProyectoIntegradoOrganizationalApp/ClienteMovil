...
export const useFriendApi = (fetch: boolean) => {
  ...
  const fetchUsers = async (name: string) => {
    ...
    try {
      const response = await useAxios(props);
  ...
  const acceptFriendRequest = (userId: string | undefined) => {
    const props: RequestParams = {
      url: `${API}/friend/${userId}/accept`,
      method: "GET",
      headers: new AxiosHeaders({
        "Content-Type": "application/json",
        Authorization: `Bearer ${user?._token}`,
  ...
  const denyFriendRequest = (userId: string | undefined) => {
    const props: RequestParams = {
      url: `${API}/friend/${userId}/deny`,
      method: "GET",
      headers: new AxiosHeaders({
        "Content-Type": "application/json",
        Authorization: `Bearer ${user?._token}`,
  ...
  const inviteUser = (userId: string | undefined, projectId: string) => {
    const props: RequestParams = {
      ...
      data: {
        title: "Join my proyect!",
        message: `Hi there, ${user?.name} here, Wanna be partners?`,
      },
    };
